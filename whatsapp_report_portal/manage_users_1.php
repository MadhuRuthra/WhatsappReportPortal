                  ...
                  <form class="needs-validation" novalidate="" id="frm_users" name="frm_users" action="#" method="post"
                    ...
                    <div class="card-body">
                      ...
                      <div class="clear_both form-group mb-2 row" id='id_deptadmin'>
                        ...
                        <div class="col-sm-8" style="float: right;">
                          <select name="slt_dept_admin" id='slt_dept_admin' class="form-control mb-2"
                            data-toggle="tooltip" data-placement="top" title="" tabindex="3"
                            data-original-title="Select Department Admin" onblur="func_display_loginid()"
                            onchange="func_display_loginid()">
                      ...
                      <div class="form-group mb-2 row" style="display: none">
                        ...
                        <div class="col-sm-8">
                          ...
                          <span class="input-group-addon" onclick="password_visible()" id='id_display_visiblitity'><i
                              class="icofont icofont-eye-blocked"></i></span>
                        </div>
                      </div>
                      <!-- confirm password -->
                      <div class="form-group mb-2 row" style="display: none">
                        ...
                        <div class="col-sm-8">
                          <input type="password" name="txt_confirm_password" id='txt_confirm_password'
                            class="form-control" value="Password@123" maxlength="100" tabindex="3" required=""
