...
async function ManualReportPJ(req) {
  ...
  var update_compose = await db.query(`UPDATE master_compose_whatsapp SET whatsapp_status = 'V',upload_info = '${upload_info}' WHERE compose_whatsapp_id = ? and user_id = ?`, [compose_id, user_id]);
