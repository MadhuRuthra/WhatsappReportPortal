...
// echo "==".$_SESSION['yjwatsp_user_id']."=="; exit;
...
<body style="background:url(assets/img/world_map.png); background-repeat:no-repeat; background-size:cover;">
  ...
  <div id="app">
      ...
      <div class="mt-5">
        <div class="row">
          ...
          <div class="col-12" id="tab_signin" style="display:block">
            <div class="col-3" style="float: left">&nbsp;</div>
            <div class="card card-success col-sm-12 col-md-6">
		<div style="padding-top:10px"></div>
		<img src="assets/img/cm-logo.png" alt="logo" style="width: 50%;text-align: center;margin: auto;background: transparent;">
              <div class="card-body">
                <form class="md-float-material form-material" action="#" name="frm_login" id='frm_login' method="post">
                  <div>
                    ...
                    <div class="row">
                      <div class="col-4" style="line-height: 42px;">
                        <b>Login ID</b>
                      </div>
                      <div class="col-8">
	...
	<div class="col-3 col-sm-1" style="float: left">&nbsp;</div>
          </div>
        </div>
      </div>
  </div>
