...
async function ManualUploadList(req) {
	...
	manual_list = manual_list + 
		"SELECT cwt.campaign_name, cwt.campaign_id, cwt.message_type, cwt.total_mobileno_count, cwt.whatsapp_status, cwt.compose_whatsapp_id,cwt.whatsapp_entry_date, cwt.user_id, usr.user_name, SUM(CASE WHEN cws.report_group = 'TGBase' AND cws.delivery_status is NULL THEN 1 ELSE 0 END) AS count_pj, " +
