...
$image_code = 'i';
  ...
  <div class='input-group'>
    ...
    <span class='input-group-addon'><i class='icofont icofont-ui-messaging'></i></span>
          ...
          $stateData .= "<div style='float:left; clear:both; line-height: 36px;'><div style='float:left; line-height: 36px;'>Header : </div><div style='float:left'><input type='file' style='margin-left:10px;' class='form-control' name='file_video_header' id='file_video_header' tabindex='11' disabled accept='video/mp4' data-toggle='tooltip' onblur='validate_filesizes(this)' onfocus='disable_texbox(\"file_video_header\", \"file_video_header_url\")' data-placement='top' data-html='true' title='Upload Any MP4 file, below or equal to 5 MB Size' data-original-title='Upload Any MP4, MPEG, WEBM file, below or equal to 5 MB Size'></div><div style='float:left'><span style='color:#FF0000;margin-left:20px;'>[OR]</span></div><div style='float:left'><div class='' style='margin-left:10px;'data-toggle='tooltip' data-placement='top' title='Enter Video URL' data-original-title='Enter Video URL'>
  <div class='input-group'>
    ...
    <span class='input-group-addon'><i class='icofont icofont-ui-messaging'></i></span>
          ...
          $stateData .= "<div style='float:left; clear:both; line-height: 36px;'><div style='float:left; line-height: 36px;'>Header : </div><div style='float:left'><input type='file' style='margin-left:10px;'  class='form-control' name='file_document_header' id='file_document_header' tabindex='11' accept='application/pdf' disabled data-toggle='tooltip' onblur='validate_filesizes(this)' onfocus='disable_texbox(\"file_document_header\", \"file_document_header_url\")' data-placement='top' data-html='true' title='Upload Any PDF file, below or equal to 5 MB Size' data-original-title='Upload Any PDF file, below or equal to 5 MB Size'></div><div style='float:left'><span style='color:#FF0000 ;margin-left:20px;'>[OR]</span></div><div style='float:left'><div class='' style='margin-left:10px;' data-toggle='tooltip' data-placement='top' title='Enter Document URL' data-original-title='Enter Document URL'>
  <div class='input-group'>
