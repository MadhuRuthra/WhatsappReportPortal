...
--
-- Host: localhost
-- Generation Time: Mar 29, 2024 at 04:59 AM
...
--
-- Database: `whatsapp_report_13`
--

-- --------------------------------------------------------

--
-- Table structure for table `compose_whatsapp_status_tmpl_13`
--

CREATE TABLE `compose_whatsapp_status_tmpl_13` (
...
--
-- Table structure for table `compose_whatsapp_tmpl_13`
--

CREATE TABLE `compose_whatsapp_tmpl_13` (
  `compose_whatsapp_id` int NOT NULL,
...
--
-- Indexes for table `compose_whatsapp_status_tmpl_13`
--
ALTER TABLE `compose_whatsapp_status_tmpl_13`
...
--
-- Indexes for table `compose_whatsapp_tmpl_13`
--
ALTER TABLE `compose_whatsapp_tmpl_13`
...
--
-- AUTO_INCREMENT for table `compose_whatsapp_status_tmpl_13`
--
ALTER TABLE `compose_whatsapp_status_tmpl_13`
  MODIFY `comwtap_status_id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `compose_whatsapp_tmpl_13`
--
ALTER TABLE `compose_whatsapp_tmpl_13`
