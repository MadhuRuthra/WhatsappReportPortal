...
//	console.log(user_id);
	...
	$('#user_id').val(user_id);
      ...
      $('#approve-Modal').find('.btn-success').on('click', function () {
        ...
        var fileInput = document.getElementById('file_image_header');
            ...
            // Prepare FormData object to send file
	...
	formData.append('user_id', user_id);
        ...
        $('#approve-Modal').modal('hide'); // Hide modal when button is clicked

         //func_save_phbabt(formData);
      });
    }

    // Function to submit the form
    function submitForm() {
      var formData = new FormData(document.getElementById("fileForm")); // Create FormData object from the form
      var file = formData.get("file_image_header"); // Get the file from FormData
	...
	var user_id = document.getElementById("user_id").value;
      ...
      func_save_phbabt(file, compose_whatsapp_id, report_group, user_id)
      $('#approve-Modal').modal('hide'); // Hide modal after handling file
    }
