                  ...
                  <form class="needs-validation" novalidate="" id="frm_message_credit" name="frm_message_credit"
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-2 row" style="display: none;">
                        ...
                        <div class="col-sm-9">
                          ...
                          <input type="text" name="txt_parent_user" id='txt_parent_user' class="form-control"
                            ...
                            data-original-title="Parent User" tabindex="1" value="<?= $_SESSION["yjwatsp_parent_id"] ?>">
                        </div>
                      </div>
                          ...
                          <select name="txt_pricing_plan" id='txt_pricing_plan' class="form-control"
                            ...
                            if ($state1->num_of_rows > 0) {
                              for ($indicator = 0; $indicator < $state1->num_of_rows; $indicator++) {
                                ...
                                <option
                                  value="<?= $_SESSION['yjwatsp_user_id'] . "~~" . $state1->report[$indicator]->pricing_slot_id . "~~" . $state1->report[$indicator]->price_from . "~~" . $state1->report[$indicator]->price_to . "~~" . $state1->report[$indicator]->price_per_message ?>"
                                  <? if ($indicator == 0) { ?>selected<? } ?>>
                                  <?= $state1->report[$indicator]->price_from . " - " . $state1->report[$indicator]->price_to . " [Rs." . $state1->report[$indicator]->price_per_message . "]" ?>
                                </option>
                                <?
                              }
                      ...
                      <div class="form-group mb-2 row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="usrcrdbt_comments" id='usrcrdbt_comments' class="form-control"
                            maxlength="200" style="height:40px;" value="<?= $usrcrdbt_comments ?>" tabindex="4"
