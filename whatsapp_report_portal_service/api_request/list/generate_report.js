...
async function generatereport(req, res) {
    ...
    csvWriter.writeRecords(data)
        .then(async () => {
            ...
            var update_summary = `UPDATE whatsapp_report.user_summary_report SET total_waiting = 0,total_process = 0,total_failed = ${failed_count},total_read = ${read_count},total_delivered = ${delivery_count},total_success = ${success_count},sum_end_date = CURRENT_TIMESTAMP,report_status = 'Y' WHERE com_msg_id = '${campaign_id}' and user_id = '${user_id}'`;
