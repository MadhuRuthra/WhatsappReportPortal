...
?>
        ...
        <!-- Header Name -->
                          <div style="display: none; margin-left:4px; " id="text"
                           >
                          </br><div type="text" contenteditable="true"  name="txt_header_name" id='txt_header_name' class="form-control custom-width"  onkeypress="return /^[a-zA-Z0-9]*$/.test(String.fromCharCode(event.charCode))"
                        ...
                        <div class="col-sm-7">
                          <div>
                            <input type="text" name="txt_footer_name" id='txt_footer_name' tabindex="13"
                              class="form-control" value="<?= $txt_footer_name ?>" maxlength="60"  onkeypress="return /^[a-zA-Z0-9]*$/.test(String.fromCharCode(event.charCode))"
